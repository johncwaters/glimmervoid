...
const DISPATCH_WORKDIR_MARKERS: readonly string[] = Object.freeze([
  'glimmervoid-visions', 'glimmervoid-memory-distill', 'glimmervoid-change-narrative', 'glimmervoid-wt-pr-review', 'glimmervoid-wt-team-review', 'glimmervoid-wt-radar-fix',
]);
